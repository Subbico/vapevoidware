...
task.spawn(function()
    local res = game:HttpGet('https://api.github.com/repos/Subbico/Subbico/contents/Profiles')
...
return loadstring(game:HttpGet("https://raw.githubusercontent.com/Subbico/Subbico/main/NewMainScript.lua", true))()